...
def main():
    # ===== 输入路径 =====
    median_path = r"I:\Version02\Ensemble_SSP245\Rhizosheath_SSP245_median.asc"
    sd_path     = r"I:\Version02\Ensemble_SSP245\Rhizosheath_SSP245_sd.asc"

    # 阈值（P10）
    threshold = 0.29445

    # ===== 输出路径 =====
    output_dir = r"I:\Version02\Ensemble_SSP245"
